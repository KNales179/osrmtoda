  ...
  try {
    ...
    if (driver && driverPasswordMatch && operator && operatorPasswordMatch) {
      ...
      if (driver.profileID === operator.profileID) {
        console.log("✅ Login successful as BOTH:", driver.driverName);
    ...
    if (driver && driverPasswordMatch) {
      console.log("✅ Login successful as DRIVER:", driver.driverName);
      return res.status(200).json({
        message: "Login successful",
        userType: "Driver",
        userId: driver._id,
    ...
    if (operator && operatorPasswordMatch) {
      console.log("✅ Login successful as OPERATOR:", operator.operatorName);
      return res.status(200).json({
        message: "Login successful",
        userType: "Operator",
        userId: operator._id,
